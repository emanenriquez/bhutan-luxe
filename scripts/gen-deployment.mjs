...
//
// Which deployment is built comes from DEPLOYMENT, defaulting to edge8.
...
export const GENERATED = "app/(admin)/events.ts";
export const GENERATED_NAV = "app/(admin)/nav.ts";
export const GENERATED_CRONS = "vercel.json";
export const GENERATED_ENV = "app/(admin)/env.ts";
...
export function cronMounts(root) {
  const dir = path.join(root, "app/(admin)/api/cron");
