...
import { listMeetings, listClientCompanies, type AdminMeetingRow } from "@/entities/crm/lib/meetings";
...
export default async function MeetingsPage(props: { searchParams: Promise<SearchParamsObj> }) {
