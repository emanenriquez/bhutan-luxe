...
import { getCompaniesSummary } from "@/entities/crm/lib/company-summary";
...
export default async function CompaniesPage(props: { searchParams: Promise<SearchParamsObj> }) {
