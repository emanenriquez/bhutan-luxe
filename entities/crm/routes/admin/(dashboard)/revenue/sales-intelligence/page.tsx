...
import { listCalls, scorecardAverage, type CallRow } from "@/entities/crm/lib/calls";
...
export default async function SalesIntelligencePage(props: { searchParams: Promise<SearchParamsObj> }) {
