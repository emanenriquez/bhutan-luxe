...
export async function resendPortalInvite(teamMemberId: string): Promise<Result> {
  ...
  await sendTransactionalEmail({
    to: t.email,
    subject: "Your Bhutan Luxe CRM Team sign-in link",
    html: `
      <p>Here is your sign-in link for the Bhutan Luxe CRM Team workspace:</p>
      <p style="margin:20px 0;"><a href="${verifyUrl}" style="display:inline-block;background:${PALETTE.dark};color:${PALETTE.white};text-decoration:none;font-weight:600;padding:12px 28px;border-radius:10px;">Sign in to the Bhutan Luxe CRM Team workspace</a></p>
