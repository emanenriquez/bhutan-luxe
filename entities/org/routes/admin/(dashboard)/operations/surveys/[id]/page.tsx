...
import { countEntity } from "@/entities/company-os";
import { PageHead } from "@/kernel/ui/PageHead";
import type { SurveyFieldRow, SurveyRow } from "@/entities/org/lib/surveys";
import { SurveyBuilder } from "./SurveyBuilder";

export default async function SurveyBuilderPage(props: { params: Promise<{ id: string }> }) {
