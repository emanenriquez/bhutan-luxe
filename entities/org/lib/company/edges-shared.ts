// Shared types + constants for the strategy
// page and the company goals editor. Lives in lib/ so the library layer is not pinned
// to an admin URL path.

// No default accountable person in a fresh install; the editors fall back to "unassigned".
export const DEFAULT_ACCOUNTABLE_PERSON_ID: string | null = null;
...
export const BRANDS = ["bhutan-luxe"] as const;
