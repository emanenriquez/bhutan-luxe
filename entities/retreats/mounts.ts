...
export const mounts: RouteMounts = {
  ...
  "routes/reserve/layout": {
    styles: ["@/entities/retreats/routes/reserve/reserve.css", "@/app/(admin)/styles/site-components.css", "@/app/(admin)/styles/utilities.css"],
  },
  ...
  "routes/vietnam-adventure-info-form/layout": {
    styles: ["@/entities/retreats/routes/vietnam-adventure-info-form/vietnam-adventure-info-form.css", "@/app/(admin)/styles/site-components.css", "@/app/(admin)/styles/utilities.css"],
  },
