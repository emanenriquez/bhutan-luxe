...
import { getAnalyticsOverview, toBars } from "@/entities/company-os";
import {
  ...
  return (
    <div>
      ...
      <section className="admin-card admin-section-card">
        ...
        <p className="admin-page-sub u-mt-1">
          The marketing site only. The CRM (admin, team, and client portal) is excluded, since
          ...
          <Link href="/admin/operations/analytics?segment=internal">See CRM usage</Link>.
        </p>
          ...
          <div className="admin-card admin-chart-card">
            ...
            {delivery.error ? (
              ...
              <div className="admin-empty u-mt-3">
                ...
                <code>${process.env.NEXT_PUBLIC_SITE_URL ?? ""}/api/webhooks/resend/</code> (trailing slash required) and
