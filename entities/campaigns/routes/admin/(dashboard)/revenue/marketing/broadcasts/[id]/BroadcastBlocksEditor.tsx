...
import type { BroadcastBlocks, BroadcastLayout } from "../../../../../../../lib/marketing-email-blocks";
    ...
    <section className="admin-card admin-section-card">
      ...
      <div className="admin-form u-mt-3">
        ...
        <div className="admin-field">
          ...
          <input id="ctaUrl" className="admin-input" type="url" value={ctaUrl} disabled={!isDraft} placeholder="https://your-domain.com/contact/" onChange={(e) => setCtaUrl(e.target.value)} />
        </div>
