...
import {
  ...
  type PillarOption,
} from "@/entities/campaigns/lib/marketing-calendar-shared";
import { BLOG_TYPES, IMAGE_STYLES, SOCIAL_STYLES, type BrandStylePrefs, type StyleOption } from "@/entities/campaigns/lib/style-catalogues";
import type { AssetImage } from "@/entities/campaigns/lib/marketing-images";
    ...
    <div className="u-stack ">
      ...
      {entry.channel === "blog" && (
        <div className="admin-card u-p-3">
          ...
          <div className="admin-hint u-mt-2">
            Publishes straight to bhutan-luxe.com from the database: validates the post, sets it live, and
