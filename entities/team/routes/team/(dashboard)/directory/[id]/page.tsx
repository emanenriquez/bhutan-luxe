...
import { getMemberProfile } from "@/entities/team/lib/data";
import { getCoachingProfileIdForMember, getTeamMemberActiveGoals } from "@/entities/coaching";
import { TeamGoalsEditor } from "@/entities/coaching";
