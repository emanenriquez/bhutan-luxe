...
import { IDEA_STATUS_LABEL, OFFICE_LABEL, ideaStatusTone, officeTone, type IdeaOffice, type IdeaStatus } from "@/entities/ideas";
...
export default async function IdeaDetailPage(props: { params: Promise<{ id: string }> }) {
