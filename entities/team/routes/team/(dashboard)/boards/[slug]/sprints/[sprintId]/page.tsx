...
import { SprintView } from "@/entities/boards";
import { listRecentMeetings } from "@/entities/boards";
...
export default async function TeamSprintPage(props: { params: Promise<{ slug: string; sprintId: string }> }) {
