...
import { getClientDocumentsForActor, getActorEmail, companyHasPrograms } from "@/entities/team/lib/hub-clients";
...
export default async function TeamClientDocumentsTab(props: { params: Promise<{ companyId: string }> }) {
