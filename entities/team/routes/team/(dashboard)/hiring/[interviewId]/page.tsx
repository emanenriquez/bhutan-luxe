...
import { type RecommendationKey } from "@/entities/hiring";
import { RECOMMENDATIONS } from "@/entities/hiring";
...
export default async function InterviewKitPage(props: { params: Promise<{ interviewId: string }> }) {
