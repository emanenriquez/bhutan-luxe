...
export const mounts: RouteMounts = {
  ...
  "routes/8-edges-app/layout": {
    styles: ["./eight-edges-app.css", "@/app/(admin)/styles/site-components.css", "@/app/(admin)/styles/utilities.css"],
  },
  "routes/about/layout": {
    styles: ["./about.css", "@/app/(admin)/styles/site-components.css", "@/app/(admin)/styles/utilities.css"],
  },
  "routes/about/opengraph-image": {
    segment: { runtime: 'nodejs' },
  },
  "routes/ai-programs/layout": {
    styles: ["./ai-programs.css", "@/app/(admin)/styles/site-components.css", "@/app/(admin)/styles/utilities.css"],
  },
  "routes/ai-programs/opengraph-image": {
    segment: { runtime: 'nodejs' },
  },
  "routes/blog/layout": {
    styles: ["./blog.css", "@/app/(admin)/styles/site-components.css", "@/app/(admin)/styles/utilities.css"],
  },
  "routes/blog/opengraph-image": {
    segment: { runtime: 'nodejs' },
  },
  "routes/caio-leadership/layout": {
    styles: ["@/app/(admin)/styles/site-components.css", "@/app/(admin)/styles/utilities.css"],
  },
  ...
  "routes/careers/layout": {
    styles: ["./careers.css", "@/app/(admin)/styles/site-components.css", "@/app/(admin)/styles/utilities.css"],
  },
  ...
  "routes/case-studies/layout": {
    styles: ["./case-studies.css", "@/app/(admin)/styles/site-components.css", "@/app/(admin)/styles/utilities.css"],
  },
  "routes/contact/layout": {
    styles: ["./contact.css", "@/app/(admin)/styles/site-components.css", "@/app/(admin)/styles/utilities.css"],
  },
  ...
  "routes/post/layout": {
    styles: ["./post.css", "@/app/(admin)/styles/site-components.css", "@/app/(admin)/styles/utilities.css"],
  },
  "routes/training-and-certification/layout": {
    styles: ["./training-and-certification.css", "@/app/(admin)/styles/site-components.css", "@/app/(admin)/styles/utilities.css"],
  },
