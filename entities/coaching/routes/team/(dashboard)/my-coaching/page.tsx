...
import { getMyCoaching } from "@/entities/coaching";
import { coachingMarkdownToHtml } from "@/entities/coaching/lib/markdown";
import { MyCoachingHeader } from "@/entities/coaching/ui/MyCoachingHeader";
...
export default async function MyCoachingPage(props: { searchParams?: Promise<{ tab?: string }> }) {
