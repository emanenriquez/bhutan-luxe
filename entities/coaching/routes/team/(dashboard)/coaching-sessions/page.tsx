...
import { listCoachingSessions, type CoachingSessionRow } from "@/entities/coaching/lib/sessions";
...
export default async function CoachingSessionsPage(props: { searchParams: Promise<SearchParamsObj> }) {
