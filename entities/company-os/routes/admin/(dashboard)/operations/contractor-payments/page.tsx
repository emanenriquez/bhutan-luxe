...
import { PAYMENT_STATUSES, formatHours, paymentTone } from "@/entities/company-os/lib/contractors";
...
export default async function ContractorPaymentsPage(props: { searchParams: Promise<SearchParamsObj> }) {
