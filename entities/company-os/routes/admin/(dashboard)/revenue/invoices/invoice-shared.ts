...
export type InvoiceEntity = "bhutan-luxe";
...
export const ENTITY_LABEL: Record<InvoiceEntity, string> = { "bhutan-luxe": "Bhutan Luxe" };
...
const QBO_REALM_ID: Record<InvoiceEntity, string> = {
  // Set QBO_REALM_ID in the environment once QuickBooks is connected.
  "bhutan-luxe": process.env.QBO_REALM_ID ?? "",
};

export function qboInvoiceUrl(externalId: string, entity: InvoiceEntity = "bhutan-luxe"): string {
