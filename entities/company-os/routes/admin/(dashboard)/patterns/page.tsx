...
// Living style guide for the Bhutan Luxe CRM admin design system. Renders every token
  ...
  return (
    <div>
      <PageHead
        ...
        title="Pattern library"
        sub="The living reference for the Bhutan Luxe CRM admin. Every token and component below renders the real admin.css classes, so this page tracks the system exactly."
