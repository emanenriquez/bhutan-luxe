...
export const metadata = {
  title: "Sync",
  description: "Bhutan Luxe CRM: the weekly heartbeat. The Monday packet, prepared Sunday 18:00 by the product manager agent.",
};
...
export default async function SyncPage() {
  const { data, error } = await companyOs.from("sync_packets").select("id, week_start, body_md, created_by, created_at")
