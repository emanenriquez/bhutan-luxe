...
describe("app/ mounts the library entity without holding its code", () => {
  ...
  // ignored. These six are every route the library forces dynamic today; a
  ...
  it.each(forcedDynamic)("%s forces its segment dynamic", (rel) => {
    // app/ is generated (scripts/gen-app-mounts.mjs), which terminates the
    // statement; the quote style is the entity's own declaration, carried
    // through verbatim.
