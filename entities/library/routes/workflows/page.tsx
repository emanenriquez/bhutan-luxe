...
import { allWorkflows } from '@/entities/library/lib/workflowsData'
import WorkflowsBrowser from './browser'

export default function WorkflowsPage() {
  const built = allWorkflows.filter((w) => w.status === 'built').length
  const planned = allWorkflows.length - built
  return (
    <main>
        ...
        <div className="container">
          <div className="wf-hero-inner">
            ...
            <p className="wf-hero-sub u-mt-3">
              Built means a scheduled agent on our Settings page runs it today. Planned means the workflow is designed
              and documented, and a person or a local task still carries it.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="section u-pt-9">
        <div className="container u-center-text">
          ...
          <p className="section-sub u-mx-auto u-mb-6">
            Every system on this page was designed and documented by Edge8, and the built ones run our company today.
