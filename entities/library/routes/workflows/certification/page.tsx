...
const ELEMENTS: WorkflowElement[] = [
  ...
  { name: 'Delivery', assignment: 'machine', desc: 'Certification plus a portfolio of artifacts the learner keeps and their team keeps using. For Edge8 members, progress is mirrored nightly onto the Get certified card on their team home.' },
  { name: 'Measurement', assignment: 'both', desc: 'Modules completed per track, read off the Institute each night, and the only metric that matters at the end: is the program shipped and running?' },
]
      ...
      <section className="section">
        <div className="container">
          ...
          <div className="wf-info-grid">
            ...
            <div className="wf-info-card">
              <h3>How it shows up at Edge8</h3>
              <ul>
                <li>The learning happens on the AI Officer Institute; the only automation on our side is a nightly sync</li>
                <li>Every night at 03:30 Ho Chi Minh time a routine reads each member&apos;s progress on the two tracks, AI Officer and AI Engineer, from the Institute</li>
                <li>Learners are matched to a person record by email; the progress lands on the Get certified card on their team home as modules completed and a status: not started, in progress, certified</li>
                <li>It never deletes, only rewrites a person whose progress changed, and reports unmatched learners rather than failing; only a real fetch or database error alarms ops in Lark</li>
                <li>Until the first sync a member reads not started, which is a real state, never a made-up number</li>
              </ul>
            </div>
          </div>
