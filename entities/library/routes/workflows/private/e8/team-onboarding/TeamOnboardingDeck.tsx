  ...
  return (
    <div className={['deckRoot', fontClassName].filter(Boolean).join(' ')}>
      <div className="progress">
        <div className="progress-fill" style={{ width: `${((current + 1) / TOTAL) * 100}%` }} /* layout-ok: data-driven progress width */ />
      </div>
              ...
              <div>
                ...
                <div className="team-block">
                  ...
                  <ul>
                    ...
                    <li>
                      <span className="name">Derek Nguyen</span> : AI Engineer
                    </li>
                  </ul>
                </div>
              </div>
