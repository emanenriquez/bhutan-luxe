...
const NODES: LaneNode[] = [
  ...
  },
  {
    ...
    desc: 'Designed to fire the moment the hire is marked, carrying the onboarding form link and doubling as the Day 0 welcome under the recruiter name. Today the recruiter sends it by hand.',
  },
  {
    num: '4',
    lane: 'system',
    ...
    desc: 'Alongside the paperwork, seven touches introduce Edge8 across the notice period. Designed as a scheduled drip with two human touches; no routine sends it yet, so each touch goes out by hand. Detailed below.',
  },
  {
    num: '5',
    lane: 'contractor',
  ...
  },
  {
    ...
    desc: 'Completing the form sends a portal invite to their personal email when they came through the hiring pipeline. No admin ticket, and no wait on the Lark account.',
  },
  {
    num: '8',
    lane: 'contractor',
...
// The 30-day pre-boarding nurture drip. Designed to send itself except two touches that are human by rule:
...
const DRIP: Touch[] = [
  ...
  },
  {
    ...
    body: (
      <p>
        A note, automated in the design, that tells the Edge8 story: the operator lineage from Microsoft to Vinasource to TINYpulse,
  ...
  },
  {
    ...
    body: (
      <p>
        ...
        Ownership, Learn and Share, and Have Fun Building. Meant to send itself, with a light prompt to reply with the
  ...
  },
  {
    ...
    body: (
      <p>
        An introduction, scheduled in the design, to their manager and the people they are about to work with: faces, roles, and where
...
const ELEMENTS: WorkflowElement[] = [
  {
    name: 'Trigger',
    assignment: 'human',
    desc: 'A recruiter marks an applicant hired in the ATS. That single decision is designed to start the paperwork and the nurture drip at the same time; today it starts the recruiter checklist.',
  },
  {
    name: 'Inputs',
    assignment: 'both',
  ...
  },
  {
    name: 'Routing',
    assignment: 'machine',
    desc: 'The form submission fans out: the applicant match, the pre-boarding record, and the portal invite. The hire event fanning out the onboarding email and the 30-day drip is designed, not yet scheduled. A direct hire with no applicant on file routes a backfill notice to operations.',
  },
  {
    name: 'Output',
    assignment: 'machine',
  ...
  },
  {
    name: 'Delivery',
    assignment: 'machine',
    desc: 'The portal invite sends itself on form completion. The onboarding email and the seven nurture touches are designed to, and go out by hand until the routine exists.',
  },
  {
    name: 'Measurement',
    assignment: 'machine',
    desc: 'Every stage transition is stamped. Once the drip runs, it will record which touches sent and where a hire goes quiet, so silence becomes a signal instead of a surprise.',
  },
]
  ...
  return (
    <main>
      <WorkflowHero
        ...
        tldr="Hiring ends where onboarding begins. The moment a recruiter marks an applicant hired, the paperwork and the welcome start together. A self-serve form promotes the same record to pre-boarding with a portal account waiting, while a 30-day nurture drip introduces Edge8 across the notice period. Seven touches, designed to run on a schedule (not yet a routine), with a recruiter welcome to open and a manager note to close. Both land the new member at Day 1 ready to start."
        meta={[
      ...
      <section className="section wf-section--tint">
        <div className="container">
          ...
          <p className="section-sub u-mt-3">
            The drip is designed to run in English, to the new member&rsquo;s personal email, on a schedule. No routine
            sends it yet: a recruiter sends the touches below by hand. It is warm and light on purpose: someone working
            a notice period needs only enough to feel they made the right call. Two touches are human by rule; the numbered
        ...
        <div className="container">
          ...
          <div className="wf-info-grid">
            ...
            <div className="wf-info-card wf-info-card-mint">
              ...
              <ul>
                <li>The onboarding form and its link, and five of the seven drip touches, once the schedule is built</li>
          ...
          <div className="wf-info-grid">
            <div className="wf-info-card">
              ...
              <ul>
                ...
                <li>Two touches are human by rule, a recruiter welcome on Day 0 and a manager note on Day 30; the rest are designed to send automatically</li>
