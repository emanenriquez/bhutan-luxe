...
const ELEMENTS: WorkflowElement[] = [
  ...
  { name: 'Routing', assignment: 'machine', desc: 'Every transition notifies the right person automatically by email: the contractor gets the brief and each decision, the client gets the estimate and the finished work, the accountant gets every billing outcome. The ops Lark channel sees every step.' },
            ...
            steps={[
              {
                ...
                body: (
                  <p>
                    The portal offers five doors: a general request that lands in the CRM inquiries pipeline, a project
                    brief aimed at a specific contractor, a full-time hire in Vietnam, pre-paid human token packs (40
                    tokens for $2,000, one token per hour of skilled work), and an AI program plan. This workflow follows
                    the project brief.
                  </p>
                ),
              },
              {
                ...
                body: (
                  <p>
                    The brief goes straight to the contractor by email, with a secure link to their own work page. They
                    come back with an estimate: hours and a plan, and the client is emailed the moment it is ready. No
                    account manager translating in the middle.
                  </p>
                ),
              },
              {
                ...
                body: (
                  <p>
                    Decision one. The client approves, requests changes, or declines, right in the portal, and the
                    contractor is emailed the decision. Nothing gets built and nothing gets billed until they say go.
                  </p>
                ),
              },
              {
                ...
                body: (
                  <p>
                    The contractor delivers and submits actual hours and a link to the result through the same request,
                    and the client is emailed that it is ready, so they see exactly what they are being asked to sign off
                    on.
                  </p>
                ),
              },
              {
                ...
                body: (
                  <p>
                    Decision two. The client reviews the work and accepts it, or sends it back for revision with a note
                    (the note is required). Acceptance is the only thing that triggers billing.
                  </p>
                ),
              },
              {
                ...
                body: (
                  <p>
                    The moment the work is accepted, an invoice is created in QuickBooks for the hours delivered at the
                    contractor&apos;s billable rate, QuickBooks emails it to the client, and it is mirrored into the invoice
                    ledger so the account view is current immediately. If anything is off (no hours, no client company,
                    no billable rate, or QuickBooks says no), the request is flagged for manual invoicing, the accountant
                    is emailed and ops pinged in Lark, instead of the system guessing. A billing problem never blocks
                    acceptance.
                  </p>
                ),
              },
