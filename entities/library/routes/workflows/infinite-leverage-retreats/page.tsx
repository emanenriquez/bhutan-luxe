...
const ELEMENTS: WorkflowElement[] = [
  ...
  },
  {
    name: 'Measurement',
    assignment: 'machine',
    desc: 'Profit per retreat is totalled by the record from the lines a person enters, in one currency, the day it ends rather than weeks later. Tracking projects against the day-one plan is designed, not yet in the record.',
  },
]
        ...
        <div className="container">
          ...
          <FlowRail
            ...
            steps={[
              ...
              { num: '05', title: 'Close-Out', cadence: 'Within a week', actor: 'human' },
            ]}
          />
        </div>
      </section>
            ...
            steps={[
              {
                ...
                body: (
                  <>
                    ...
                    <p>
                      The moment the deposit is in, an admin creates the retreat as an event record in our admin and
                      enters the estimated budget as P&amp;L lines. Everything after this point measures reality against
                      that plan.
                    </p>
                  </>
                ),
              ...
              },
              {
                ...
                body: (
                  <>
                    ...
                    <ul>
                      <li>Costs are entered on the retreat record the day they happen, in the currency they were paid</li>
                      <li>Project status is tracked against the plan in the daily standup, so progress is always visible</li>
              ...
              },
              {
                ...
                body: (
                  <>
                    <p>
                      Public-retreat seats were paid by card at registration, so that revenue is already known.
                      Operations enters the revenue lines and the last remaining actuals, and the retreat closes into a
                      finished profit-and-loss.
                    </p>
                    <ul>
                      <li>Revenue and costs total automatically, converted into US dollars at the stored rates</li>
                      <li>Staff time is costed at a flat day rate, so real wages never appear on the record</li>
          ...
          <div className="wf-info-grid">
            ...
            <div className="wf-info-card wf-info-card-mint">
              ...
              <ul>
                ...
                <li>Costs are entered live, so close-out is minutes instead of a half day</li>
                <li>Card revenue is known at registration, so there is nothing to chase at the end</li>
