            ...
            <table className="wf-table">
              ...
              <tbody>
                ...
                <tr>
                  <td>Transcripts</td>
                  <td>
                    Lark Minutes, auto-detected: a daily routine matches new recordings to 1-1s by the member&apos;s
                    name in the title and the date. Fallback: paste a link or raw text.
                  </td>
                </tr>
              </tbody>
            </table>
        ...
        <div className="container">
          ...
          <FlowRail
            steps={[
              ...
              { num: '05', title: 'Trend Analysis', cadence: 'After each 1-1', actor: 'ai' },
            ]}
      ...
      <section className="section">
        <div className="container">
          ...
          <p className="section-sub u-mt-3">
            ...
            07:45 routine as the scheduler plus an hourly one that drafts recaps, and Claude for prep, recaps, and
            trends, with every call failing soft so an AI error never blocks a meeting.
          </p>
          <div className="wf-table-wrap">
            <table className="wf-table">
              <thead>
              ...
              <tbody>
                <tr>
                  ...
                  <td>
                    All nudges go out as Lark DMs: prep-ready, recap-drafted, and trends-ready to the coach, mid-cycle
                    check-ins to the member. Every message has an email twin so nothing is missed, and every link lands
                    on the portal.
                  </td>
                </tr>
                <tr>
                  <td>Lark Minutes</td>
                  <td>
                    The transcript source. The daily routine auto-detects new recordings, matches them to 1-1s by the
                    member&apos;s name in the title and the date, and pulls the transcript; the hourly routine drafts
                    the recap for review.
                  </td>
                </tr>
                <tr>
          ...
          <div className="wf-info-grid u-mt-7">
            ...
            <div className="wf-info-card wf-info-card-mint">
              ...
              <ul>
                ...
                <li>The cloud routines replace the laptop-bound scheduled tasks for prep, check-ins, recaps, and trends; one local task still ships Minutes transcripts into the database where the cloud app cannot read them</li>
