  ...
  return (
    <div className="u-x-scroll u-mt-7 u-mb-2">
      ...
      >
        ...
        <text x="330" y="172" textAnchor="middle" fontSize="12" fill={sub}>0–5 rating · overview · skills · English · notice</text>
          ...
          <div className="u-mx-auto u-mt-7 u-max-8">
            <div className="u-grid-auto-md">
              ...
              <div style={loopCard}>
                ...
                <div className="u-lg wf-dim">
                  Always on: inbound, LinkedIn, referrals, agencies, batch drops, and resurfacing people we already know.
                </div>
              </div>
              <div style={loopCard}>
                ...
                body: (
                  <>
                    <p>
                      ...
                      description and writes a structured screen: a 0 to 5 fit rating, a short overview, the skills
                      that matter, a read on English, and the salary expectation and notice period exactly as stated,
                      never guessed (the salary lands in the restricted store, not on the application). Every
                      application gets the same careful read, whether it came in first or five hundredth.
                    </p>
                    <p>
                      Scored candidates are also rated against their role family&rsquo;s ideal profile, not just the
                      one job they applied to. A strong engineer who applied to the wrong opening still shows up near the top of the
                      engineering family.
                    </p>
                  </>
                ),
              ...
              },
              {
                ...
                body: (
                  <>
                    ...
                    <p>
                      The AI sits on every interview panel too. As soon as a transcript is uploaded to the round, it
                      reads it against the job description, the
                ...
                body: (
                  <>
                    <p>
                      ...
                      back to the warm shortlist, still ranked and still in the system, not back to square one.
                    </p>
                    <p>
