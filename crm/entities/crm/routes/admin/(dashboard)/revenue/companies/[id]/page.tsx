...
import { getPortalMembershipsForCompany } from "@/entities/crm/lib/portal";
...
import { getBoardBySlug, listBoardManageOptions } from "@/entities/boards";
...
import { getLiveCardItemIds } from "@/entities/boards";
import { fetchAll, listProgramSummaries, PROGRAM_SELECT, type ProgramSummary, type ProgramSummaryInputs } from "@/entities/team";
import {
  computeTokenUsage,
  fetchDeliveryRaw,
...
import { HubTeamPanel, InvoicesPanel, MeetingsPanel, hubProgramCard } from "@/entities/team";
import { moveCardColumn, Workboard } from "@/entities/boards";
...
export default async function CompanyDetailPage({
  ...
  return (
    <div>
      ...
      {hub && <AdminHubTokensBand companyId={company.id} usage={hub.usage} programs={hub.programs.map(hubProgramCard)} programHref={(programId) => `/admin/revenue/companies/${company.id}/programs/${programId}`} />}
