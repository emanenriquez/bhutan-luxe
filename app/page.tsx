        ...
        <div className="wrap">
          <div className="header">
            ...
            <div style={{ paddingTop: '38px' }}>
              <p className="intro" style={{ fontSize: '20px', fontFamily: "'Playfair Display', serif", color: '#ffffff', lineHeight: 1.4 }}>Bhutan-Luxe designs the journey; Our on-the-ground partner ensures:</p>
