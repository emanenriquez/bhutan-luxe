    ...
    <>
      ...
      <section id="desire">
        ...
        <div className="text">
          ...
          <p style={{ fontFamily: "'Playfair Display', serif", fontSize: 15, fontStyle: 'italic', color: '#FF8C00', marginTop: 6, marginBottom: 0 }}>The Secret and Timeless Kingdom of the Himalayas</p>
          <h2>
            You have been
            <br />
            everywhere &nbsp;·&nbsp; Bhutan
      ...
      <section id="tiers">
        <div className="header">
          ...
          <div className="intro">
            ...
            <a href="/weather-guide" style={{ display: 'inline-block', marginTop: '20px', fontFamily: 'Inter', fontWeight: 500, fontSize: 11, letterSpacing: '0.2em', textTransform: 'uppercase', color: 'var(--cloud)', background: 'transparent', border: '1px solid var(--gold)', padding: '10px 22px', borderRadius: 8, textDecoration: 'none' }}>Preferred Path Dates →</a>
          </div>
        </div>
      ...
      <section style={{ background: "#2D5016", padding: "80px 0" }}>
        <div style={{ maxWidth: 1100, margin: "0 auto", padding: "0 56px" }}>
          ...
          <div style={{ display: "flex", flexWrap: "wrap", gap: 36, marginBottom: 52 }}>
            {[
              { quote: "Go to Bhutan! Stop procrastinating. It is 1000% worth it... A bit of our hearts will be in Bhutan forever! ❤️", name: "Shari F.", country: "United States" },
          ...
          <div style={{ textAlign: "center" }}>
            <a href="/testimonials" style={{ display: "inline-block", fontFamily: "Inter", fontWeight: 500, fontSize: 11, letterSpacing: "0.2em", textTransform: "uppercase", color: "#000", background: "#FF8C00", padding: "12px 28px", borderRadius: 8, textDecoration: "none" }}>
              Read All Reviews ↗
            </a>
          </div>
        </div>
