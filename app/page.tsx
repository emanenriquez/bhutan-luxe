    ...
    <>
      ...
      <section id="desire">
        ...
        <div className="text">
          ...
          <p style={{ fontFamily: "'Playfair Display', serif", fontSize: 15, fontStyle: 'italic', color: '#D4A843', marginTop: 6, marginBottom: 0 }}>The Secret and Timeless Kingdom of the Himalayas</p>
          <h2>
            You have been
            <br />
            everywhere &nbsp;·&nbsp; Bhutan
