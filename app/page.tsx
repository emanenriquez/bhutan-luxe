  ...
  return (
    <>
      ...
      <div className="topbar">
        ...
        <div className="meta">
          <span style={{ color: 'var(--saffron)', textTransform: 'uppercase', letterSpacing: '0.08em', fontSize: '12px', fontWeight: 500 }}>Private Bhutan Journeys | Authentic Bhutan | Bespoke &amp; Privately Guided</span>
        </div>
