      ...
      <section id="tiers">
        <div className="header">
          ...
          <div className="intro">
            ...
            <a href="/weather-guide" style={{ display: 'inline-block', marginTop: '20px', fontFamily: 'Inter', fontWeight: 500, fontSize: 11, letterSpacing: '0.2em', textTransform: 'uppercase', color: 'var(--cloud)', background: 'transparent', border: '1px solid var(--gold)', padding: '10px 22px', borderRadius: 8, textDecoration: 'none' }}>Preferred Discovery Dates →</a>
          </div>
        </div>
        ...
        <div className="wrap">
          <div className="header">
            ...
            <div style={{ paddingTop: '180px' }}>
              ...
              <a href="/faq" style={{ display: 'inline-block', marginTop: '24px', fontFamily: 'Inter', fontWeight: 500, fontSize: 11, letterSpacing: '0.2em', textTransform: 'uppercase', color: 'var(--cloud)', background: 'transparent', border: '1px solid var(--gold)', padding: '10px 22px', borderRadius: 8, textDecoration: 'none' }}>Frequently Asked Questions →</a>
            </div>
          </div>
