...
export default function NavMenu() {
  ...
  return (
    <>
      ...
      >
        <span style={{ display: "block", width: 22, height: 2, background: "#FF8C00", borderRadius: 1 }} />
        <span style={{ display: "block", width: 22, height: 2, background: "#FF8C00", borderRadius: 1 }} />
        <span style={{ display: "block", width: 14, height: 2, background: "#FF8C00", borderRadius: 1 }} />
      </button>
      {overlay}
    </>
  );
