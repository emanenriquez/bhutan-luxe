...
// The body lives in entities/campaigns/routes/admin/(dashboard)/revenue/marketing/page; this file
...
// its mounts.ts.
export { default, metadata } from "@/entities/campaigns/routes/admin/(dashboard)/revenue/marketing/page";
