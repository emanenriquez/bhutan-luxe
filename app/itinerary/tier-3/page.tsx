...
export default function TierThreeItinerary() {
  return (
    <>
      ...
      {/* HERO */}
      <div className="no-print itin-hero-bg" style={{ background: "url('/extraordinary-hero.jpg') center 30%/cover no-repeat", minHeight: 560, display: "flex", alignItems: "flex-end", paddingTop: 80 }}>
