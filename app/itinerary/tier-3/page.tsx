...
export default function TierThreeItinerary() {
  return (
    <>
      ...
      {/* HERO */}
      <div className="no-print itin-hero-bg" style={{ background: "url('/extraordinary-hero.jpg') center/cover no-repeat", minHeight: 420, display: "flex", alignItems: "flex-end", paddingTop: 80 }}>
