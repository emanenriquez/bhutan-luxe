...
export default function TierOneItinerary() {
  return (
    <>
      ...
      {/* HERO */}
      <div className="no-print itin-hero-bg" style={{ background: "url('/discovery-hero.jpg') center/cover no-repeat", minHeight: 520, display: "flex", alignItems: "flex-end", position: "relative" }}>
        ...
        <div className="no-print" style={{ position: "absolute", top: 20, right: 40, zIndex: 80, display: "flex", alignItems: "center", gap: 12 }}>
        ...
        <div className="itin-hero-pad" style={{ width: "100%", background: "linear-gradient(to top, rgba(59,58,54,0.95) 0%, rgba(59,58,54,0.4) 60%, transparent 100%)", padding: "80px 56px 48px" }}>
          <div className="itin-hero" style={{ maxWidth: 560, textAlign: "left", marginLeft: "auto" }}>
            <h1 style={{ fontFamily: "'Playfair Display', serif", fontSize: "clamp(40px, 4.4vw, 64px)", lineHeight: 1.04, fontWeight: 400, fontStyle: "italic", color: "#FF8C00", marginBottom: "12px" }}>
              Discovery <span style={{ color: "#F7F5F0" }}>Path</span>
            </h1>
          </div>
        </div>
      ...
      <div className="print-section itin-section" style={{ background: "#F7F5F0", padding: "56px 56px 48px", color: "#3B3A36" }}>
        <div style={{ maxWidth: 760, margin: "0 auto" }}>
          ...
          <div className="no-print" style={{ marginBottom: 36, paddingBottom: 32, borderBottom: "1px solid rgba(59,58,54,0.12)" }}>
            <p style={{ fontFamily: "Inter", fontSize: 10, fontWeight: 700, letterSpacing: "0.2em", textTransform: "uppercase", color: "#D4A843", marginBottom: 14 }}>Discovery Path Lodging</p>
            <div style={{ display: "flex", flexDirection: "column", gap: 0, paddingLeft: 40 }}>
              {[
                ...
                { name: "Dhensa Boutique Resort", url: "https://dhensa.com/" },
      ...
      {/* CTA */}
      <div className="no-print itin-cta" style={{ background: "#3B3A36", padding: "80px 56px", textAlign: "center" }}>
      ...
      {/* FOOTER */}
      <div className="no-print itin-footer" style={{ background: "#2D5016", padding: "24px 56px", display: "flex", justifyContent: "space-between", alignItems: "center" }}>
